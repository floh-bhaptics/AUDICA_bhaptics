    ...
    public class TactsuitVR
    {
        ...
        public void TelKinLFunc()
        {
            while (true)
            {
                ...
                bHapticsLib.bHapticsManager.PlayRegistered("SustainVest_L");
                bHapticsLib.bHapticsManager.PlayRegistered("SustainArm_L");
                bHapticsLib.bHapticsManager.PlayRegistered("SustainHand_L");
                Thread.Sleep(1020);
            }
        }
        ...
        public void TelKinRFunc()
        {
            while (true)
            {
                ...
                bHapticsLib.bHapticsManager.PlayRegistered("SustainVest_R");
                bHapticsLib.bHapticsManager.PlayRegistered("SustainArm_R");
                bHapticsLib.bHapticsManager.PlayRegistered("SustainHand_R");
                Thread.Sleep(1020);
            }
        }
...
#pragma warning restore CS0618
        ...
        public void hitHand(bool isRight)
        {
            ...
            if (bHapticsLib.bHapticsManager.IsDeviceConnected(bHapticsLib.PositionID.HandRight)) deviceName = "Hand";
        ...
        public void hitArm(bool isRight)
        {
            ...
            if (bHapticsLib.bHapticsManager.IsDeviceConnected(bHapticsLib.PositionID.ArmRight)) deviceName = "Arm";
            string key = "Recoil" + deviceName + postfix;
            bHapticsLib.bHapticsManager.PlayRegistered(key, key, scaleOption, rotationFront);
        }
